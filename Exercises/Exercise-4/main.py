...
# passing flatten_json a loaded json file and it returns an amended dictionary of that file contents
    ...
    for root, dirs, j_files in os.walk(path):
        for j in j_files:
            if j.endswith('.json'):
                ...
                print("Reading json file and ready to open:", file_path)
                with open(file_path, 'r') as json_file:
                    data = json.load(json_file)
                    print(f'f loading json file: {json_file}')
